    ...
    <div className="p-6 max-w-5xl mx-auto">
      ...
      <div className="flex gap-3 mb-6">
        <input
          ...
          className="flex-1 px-4 py-2.5 text-sm border border-gray-200 rounded-lg bg-white text-gray-900 placeholder-gray-400 outline-none focus:ring-2 focus:ring-blue-500"
        />
        <button
      ...
      {!result && !loading && (
        <div className="text-center py-16 text-gray-400">
          ...
          <p className="text-sm">Enter your URL above and click Analyze to get started.</p>
        </div>
      )}
