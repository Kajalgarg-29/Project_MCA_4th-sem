...
export interface User { userId: number; username: string; email: string; profilePictureUrl?: string; teamId?: number; team?: Team; }
...
export interface Campaign { id: number; name: string; description?: string; status: string; type: string; budget?: number; spent?: number; startDate?: string; endDate?: string; target?: string; reach?: number; clicks?: number; conversions?: number; createdAt: string; updatedAt: string; }
export interface CalendarEvent {
  id: number; title: string; description?: string; type: string;
  date: string; startTime?: string; endTime?: string;
  location?: string; attendees?: string; color: string;
