...
export default function DashboardPage() {
  ...
  const stats = [
    ...
    { label: "Pending Review", value: "—", icon: Clock, color: "bg-orange-50 text-orange-600" },
  ];
    ...
    <DashboardWrapper>
      <div className="p-6 max-w-7xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-400 text-sm mt-1">Overview of your projects and tasks</p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-6 mb-6">
          <div className="bg-white rounded-xl p-5 shadow-sm border border-gray-100">
            <h2 className="font-semibold text-gray-800 mb-4">Tasks by Project</h2>
