    ...
    <DashboardWrapper>
      <div className="p-4 sm:p-6 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col xs:flex-row xs:items-center justify-between gap-3 mb-5 sm:mb-6">
          <div>
            <h1 className="text-xl sm:text-2xl font-bold text-gray-800?text-white">
              Users
            </h1>
              ...
              return (
                <div key={user.userId} className="p-4">
                  ...
                  <div className="flex flex-wrap items-center gap-2 mt-3">
                    <span
                      className={`inline-flex items-center gap-1 text-xs px-2 py-0.5 rounded-full font-medium ${ROLE_STYLES[user.role] || ROLE_STYLES.Member}`}
                    >
                      <RoleIcon size={10} />
                      {user.role || "Member"}
                    </span>
                    <span
                      className={`text-xs px-2 py-0.5 rounded-full font-medium ${user.teamId ? "bg-green-50 text-green-600" : "bg-gray-100 text-gray-500"}`}
                    >
                      {user.teamId ? "● Active" : "○ Unassigned"}
                    </span>
                    {user.team?.teamName && (
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm outline-none focus:border-blue-400 text-gray-900 bg-white placeholder-gray-400"
                />
              </div>
              <div>
                <label className="text-xs font-semibold text-gray-600 block mb-1.5">
